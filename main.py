...
def start_ticket_process(user_id):
    if active_user_sessions.get(user_id, False):
        return False
    active_user_sessions[user_id] = True
    return True

def end_user_session(user_id):
    active_user_sessions[user_id] = False
...
def admin_panel(message):
    try:
        ...
        end_user_session(message.from_user.id)
...
def handle_admin_actions(call):
    try:
        ...
        end_user_session(call.from_user.id)
